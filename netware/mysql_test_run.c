...
void start_master();
void start_slave_all(THD* thd);
void start_slave();
void mysql_start();
void stop_slave_all(THD* thd);
void stop_slave();
void stop_master();
void mysql_stop();
void mysql_restart();
...
/******************************************************************************
  ...
  Start the all slave servers. Multi-Master By vagner@
...
/******************************************************************************
  ...
  Stop the all slave servers. Multi-Master By vagner@
