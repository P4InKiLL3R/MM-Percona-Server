...
public:
  ...
  bool remove_all_master_info_from_hash(Master_info* mi);
  ...
  /* Add MM get info for all masters By Vagner@ */
  /* Get a Master_info class via Hash Index */
  Master_info* get_all_master_info_from_hash(ulong idx)
  {
    Master_info* mi= (Master_info*) my_hash_element(&master_info_hash, idx);
    return mi;
  }
  /* End */
};
